"""Reusable Rich console display utilities for client."""
...
class ClientDisplay:
    """Reusable display handler for client UI using Rich."""
    ...
    def print_connection_banner(
        ...
        """
        Print client connection banner.
        ...
        """
        banner = Text()
        banner.append("Secure TCP Client\n", style="bold cyan")
        banner.append(f"Connecting to {host}:{port}\n\n", style="white")
